...
{
	public const string HANDLE_HEALT_BAR = "HEALT_BAR";
	public const string HANDLE_DAMAGE_ENVIRONMENT = "DAMAGE_ENVIRONMENT";
	public const string HANDLE_COLLECT_APPLE = "COLLECT_APPLE";
	public const string HANDLE_COLLECT_CHICKEN = "COLLECT_CHICKEN";
	public const string HANDLE_HEALING = "HEALING";
	public const string HANDLE_POWERUP_ON = "POWERUP_ON";
	public const string HANDLE_POWERUP_OFF = "POWERUP_OFF";
